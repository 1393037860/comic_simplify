...
// 2.1.1 重构: killCustomAds 废弃"全页启发式扫描"(曾多次误删 header/nav/轮播/章节列表等正常元素),
//     改为"精准删除": 仅清理 ①via_inject 伪装样式表 ②Vxop/Mhvp/kUyi 广告标识元素
//     ③直挂 body 的空自定义标签占位(带内联尺寸) ④CSS雪碧点击格; 标准标签/站点UI 结构上不可能被删
